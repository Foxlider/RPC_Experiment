...
class BasicStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Handshake = channel.unary_unary(
                ...
                response_deserializer=basic__pb2.Pong.FromString,
                )
...
def add_BasicServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Handshake': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=basic__pb2.Pong.SerializeToString,
            ),
    }
...
class Basic(object):
    ...
    def Handshake(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/basic.Basic/Handshake',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            basic__pb2.Pong.FromString,
